...
| -----------       | -----------                       | --------                                                              |  --------                                                                                         |
| ```2MPZ```        |  Galaxy clustering                | [Bilicki et al, 2013](https://arxiv.org/pdf/1311.5246.pdf)            | [catalogue](http://ssa.roe.ac.uk/TWOMPZ.html)                                                     |
...
| ```ACTk BN```     | CMB convergence                   | [Darwish et al, 2020](https://arxiv.org/abs/2004.01139)               | [catalogue](https://lambda.gsfc.nasa.gov/product/act/act_dr4_derived_maps_get.html)               |
| ```ACTk D56```    | CMB convergence                   | [Darwish et al, 2020](https://arxiv.org/abs/2004.01139)               | [catalogue](https://lambda.gsfc.nasa.gov/product/act/act_dr4_derived_maps_get.html)               |
| ```BOSS```        | Galaxy clustering                 | [Alam et al, 2016](https://arxiv.org/abs/1607.03155)                  | [catalogue](https://data.sdss.org/sas/dr12/boss/)                                                 |
| ```CIBLenz```     | CIB ansitropies                   | [Lenz et al, 2019](https://arxiv.org/abs/1905.00426)                  | [catalogue](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/8A1SR3)      |
| ```CatWISE```     | Galaxy clustering                 | [Marocco et al, 2020](https://arxiv.org/abs/2012.13084)               | [catalogue](https://irsa.ipac.caltech.edu/data/WISE/CatWISE/gator_docs/catwise_colDescriptions.html) |
| ```DELS```        | Galaxy clustering                 | [Dey et al, 2019](https://arxiv.org/abs/1804.08657)                   | [catalogue](https://www.legacysurvey.org/dr8/catalogs/)                                           |
...
| ```NVSS```        | Galaxy clustering                 | [Condon et al, 1998](https://iopscience.iop.org/article/10.1086/300337/pdf) | [catalogue](https://www.cv.nrao.edu/nvss/)                                                  |
| ```P15tSZ```      | Compton-y map                     | [Planck Collaboration, 2015](https://arxiv.org/abs/1502.05956)        | [catalogue](https://irsa.ipac.caltech.edu/data/Planck/release_2/all-sky-maps/ysz_index.html)      |
| ```P18CMBk```     | CMB convergence                   | [Planck collaboration, 2018](https://arxiv.org/abs/1807.06210)        |                                                                                                   |
...
| ```SPT```         | Compton-y map                     | [Bleem et al, 2021](https://arxiv.org/abs/2102.05033)                 | [catalogue](https://lambda.gsfc.nasa.gov/product/spt/spt_prod_table.html)                         |  
