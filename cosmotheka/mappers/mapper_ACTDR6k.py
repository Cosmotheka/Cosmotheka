...
class MapperACTDR6k(MapperBase):
    ...
    Information about the data used in this mapper:
    https://lambda.gsfc.nasa.gov/product/act/actadv_dr6_lensing_maps_info.html
    Extended products available at:
    https://portal.nersc.gov/project/act/dr6_lensing_v1/
    ...
    **Config**
        ...
        - klm_file: /mnt/extraspace/damonge/Datasets/ACT_DR6/
            lensing_maps/baseline/
            kappa_alm_data_act_dr6_lensing_v1_baseline.fits
        - file_mask: /mnt/extraspace/damonge/Datasets/ACT_DR6/
            lensing_maps/baseline/
            mask_act_dr6_lensing_v1_healpix_nside_4096_baseline.fits
        - file_noise: /mnt/extraspace/damonge/Datasets/ACT_DR6/
            lensing_maps/baseline/N_L_kk_act_dr6_lensing_v1_baseline.txt
        - lmax: 4000
        - mask_threshold: 0.1  # Avoid ringing
        - variant: "baseline"
        - sims_rec_path: /mnt/extraspace/damonge/Datasets/ACT_DR6/
            lensing_maps/baseline/simulations
        - sims_in_path: /mnt/extraspace/damonge/Datasets/ACT_DR6/
            lensing_maps/baseline/simulations
    """
