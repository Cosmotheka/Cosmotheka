...
def test_cov_ng():
    ...
    tkk_ssc = ccl.halos.halomod_Tk3D_SSC(cosmo, hmc,
                                         prof1=pr, prof2=pr,
                                         prof12_2pt=prof2pt,
                                         prof3=pr, prof4=pr,
                                         prof34_2pt=prof2pt,
    ...
    covSSC1 = covc1.get_covariance_ng_halomodel('SSC', fsky=fsky)
